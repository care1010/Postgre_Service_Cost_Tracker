...
const sendMonthlyProjectAuditMail = async (adminEmails, excelBuffer, monthName) => {
    const mailOptions = {
        ...
        <div style="font-family: Calibri, Arial, sans-serif; font-size: 15px; color: #333;">
            ...
            <p>Please find attached the <strong>Monthly Project Audit Report</strong> for <strong>${monthName}</strong>.</p>
            <p>This report contains details of all <strong>New Projects</strong> and <strong>Additional WBS Elements</strong> added to the tool during the last month.</p>
            <br/>

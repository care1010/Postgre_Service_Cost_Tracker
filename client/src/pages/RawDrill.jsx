...
const CJI5_COLS = [
    ...
    { data: 'exch_rate',           title: 'EXCH_RATE' },
    { data: 'year',                title: 'YEAR' },
    { data: 'per',                 title: 'PER' },
    { data: 'cost_element',        title: 'COST_ELEMENT' },
    { data: 'cost_element_descr',  title: 'COST_ELEMENT_DESCR' },
    { data: 'matl_group',          title: 'MATL GROUP' },
    { data: 'material',            title: 'MATERIAL' },
    { data: 'description',         title: 'DESCRIPTION' },
    { data: 'user_name',           title: 'USER_NAME' },
    { data: 'docc',                title: 'DOCC' },
    { data: 'quantity',            title: 'QUANTITY' },
    { data: 'qty_plan',            title: 'QTY_PLAN' },
    { data: 'debit_date',          title: 'DEBIT_DATE' },
    { data: 'doc_date',            title: 'DOC_DATE' },
    { data: 'cocode',              title: 'COCODE' },
    { data: 'report_currency',     title: 'REPORT_CURRENCY' },
    { data: 'tcurr',               title: 'TCURR' },
